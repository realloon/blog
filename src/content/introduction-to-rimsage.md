...
如果你曾使用 AI 辅助开发 Mod，你会发现，主流 LLM 在编程“能力”上是没有问题的，但常犯“知识”错误：使用不存在的 RimWorld API。
...
模型的上下文窗口有限。目前（2026年1月）的主流 LLM 上下文窗口集中在 256K 左右，而 RimWorld 的源码，光 C# 就超过一百万行，XML 更是四百多万行，即使是有 2M 上下文的 Grok 4 Fast，也是远远无法吞下如此庞大的代码量的。
